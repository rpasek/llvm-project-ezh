...
//
// Description:
//   Declares EZHInstPrinter, formatting MCInst instructions and operands into
...
//
// Changes:
//   Renamed LanaiInstPrinter to EZHInstPrinter; declared custom printing
//   methods for EZH registers and condition codes.
//
//===----------------------------------------------------------------------===//
...
public:
  ...
  void printPerAddrOperand(const MCInst *MI, unsigned OpNo, raw_ostream &O);
