//===-- EZHAluCode.h - ALU operator encoding ----------------------------===//
//
...
#ifndef LLVM_LIB_TARGET_EZH_EZHALUCODE_H
#define LLVM_LIB_TARGET_EZH_EZHALUCODE_H
...
const int EZH_PRE_OP = 0x40;
const int EZH_POST_OP = 0x80;

inline static unsigned encodeEZHAluCode(unsigned AluOp) {
...
inline static const char *ezhAluCodeToString(unsigned AluOp) {
...
inline static AluCode stringToEZHAluCode(StringRef S) {
...
#endif // LLVM_LIB_TARGET_EZH_EZHALUCODE_H
