...
static cl::opt<bool>
AdjustJumpTableBlocks("ezh-adjust-jump-tables", cl::Hidden, cl::init(true),
          cl::desc("Adjust basic block layout to better use TB[BH]"));

static cl::opt<unsigned>
CPMaxIteration("ezh-constant-island-max-iteration", cl::Hidden, cl::init(30),
...
namespace {
  ...
  public:
    ...
    StringRef getPassName() const override {
      return EZH_CP_ISLANDS_OPT_NAME;
    }
...
void
EZHConstantIslands::doInitialConstPlacement(std::vector<MachineInstr*> &CPEMIs) {
...
bool
EZHConstantIslands::fixupUnconditionalBr(ImmBranch &Br) {
  MachineInstr *MI = Br.MI;
...
bool
EZHConstantIslands::fixupConditionalBr(ImmBranch &Br) {
  MachineInstr *MI = Br.MI;
  MachineBasicBlock *DestBB = MI->getOperand(0).getMBB();
...
bool EZHConstantIslands::optimizeThumb2Branches() {
  ...
  auto TryConvertToLE = [this](ImmBranch &Br, ImmCompare &Cmp) {
    if (Br.MI->getOpcode() != EZH::t2Bcc || !STI->hasLOB() ||
        STI->hasMinSize())
      return false;
