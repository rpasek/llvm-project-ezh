...
inline static const char *ezhCondCodeToString(CondCode CC) {
  switch (CC) {
  case ICC_EU:
    return "";
  case ICC_ZE:
...
inline static CondCode parseCondCode(StringRef Name) {
...
inline static CondCode getReversedCondCode(CondCode CC) {
  switch (CC) {
  case ICC_ZE:
    return ICC_NZ;
  case ICC_NZ:
