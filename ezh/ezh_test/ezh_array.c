...
static __attribute__((noinline)) void test_8bit_array() {
  exc_signal = 0x7002;
...
static __attribute__((noinline)) void test_16bit_array() {
  exc_signal = 0x7003;
...
static __attribute__((noinline)) void test_32bit_array() {
  exc_signal = 0x7006;
...
static __attribute__((noinline)) void test_64bit_array() {
  exc_signal = 0x7007;
