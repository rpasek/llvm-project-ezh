...
static __attribute__((noinline, optnone)) void test_3_subroutine_step_target() {
  exc_signal = 0x99999999; // Second breakpoint target signature!
}

// [Phase 3 - Step 1: step over function-entry synchronization NOPs to
// exc_signal line]
static __attribute__((noinline, optnone)) void test_3_subroutine_step() {
...
// verified)]
static __attribute__((noinline)) void test_cond_branches() {
...
static __attribute__((noinline, optnone)) void test_4_c_stepping() {
  __asm__ volatile("nop\n\t"
                   "nop\n\t");
  volatile int x = 1;
...
// =============================================================================
// PHASE 7: Breakpoint Stepping and Resuming Verification
// =============================================================================
static __attribute__((noinline, optnone)) void
test_7_breakpoint_stepping_and_resuming() {
  __asm__ volatile("nop\n\t"
                   "nop\n\t");
